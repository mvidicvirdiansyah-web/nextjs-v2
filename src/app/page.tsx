        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate-400">
              ...
              dalam membuat website modern, responsive, dan mudah digunakan.
            </p>

            <div className="mt-8 flex flex-wrap gap-4">
              <a
                href="#projects"
                className="rounded-lg border border-slate-700 px-6 py-3 font-semibold hover:border-blue-500 hover:text-blue-400"
              >
                Lihat Project →
              </a>
          ...
          <div className="flex justify-center">
            <div className="flex h-64 w-64 items-center justify-center rounded-full border border-blue-500/30 bg-blue-500/10 sm:h-72 sm:w-72 md:h-96 md:w-96">
              <div className="flex h-52 w-52 overflow-hidden rounded-full bg-slate-800 sm:h-60 sm:w-60 md:h-80 md:w-80">
                <Image
                  src="/profil.png"
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 max-w-3xl">
            <p className="text-lg leading-relaxed text-slate-400">
              Saya sedang mengembangkan kemampuan di bidang teknologi dan
              pemrograman. Saya senang mempelajari teknologi baru dan membuat
              berbagai project website untuk meningkatkan kemampuan saya.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-slate-400">
            Jika kamu ingin berdiskusi tentang project, teknologi, atau hal
            lainnya, silakan hubungi saya.
          </p>

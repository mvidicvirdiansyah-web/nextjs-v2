...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#023136] text-[#AFDDE5]">
      ...
      {/* ================= NAVBAR ================= */}
      <nav className="fixed top-0 left-0 right-0 z-50 border-b bg-[#024950] backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">

          <h1 className="text-2xl font-bold">
            <span className="text-blue-300/40">My</span>Portfolio
          </h1>
      ...
      >
        <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
          ...
          <div className="flex justify-center">
            ...
            <div className="flex h-72 w-72 items-center justify-center rounded-full border border-blue-500/30 bg-blue-500/10 shadow-2xl shadow-blue-500/10 md:h-96 md:w-96">
            
              <div className="flex h-60 w-60 items-center justify-center rounded-full bg-slate-800 text-7xl md:h-80 md:w-80 md:text-8xl">
                <Image
                src="/profil.png"
                alt="Profil"
                width={400}
